...
export interface GameConfig {
  ...
  visual: {
    sky: string; ambient: string; sun: string
    fogColor: string; fogStart: number; fogEnd: number
...
export const CONFIG = {
  ...
  hud: { heartbeat: 0.25 },
  visual: {
    sky: '#9bc4c8', ambient: '#526963', sun: '#ffe2aa',
    fogColor: '#9bc4c8', fogStart: 30, fogEnd: 72,
