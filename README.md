...
|---|---|---|
| Desktop | WASD; mouse look with pointer lock; Shift para sprint | Espacio salta, LMB rompe, RMB coloca, V cambia cámara, rueda/1–6 selecciona, Esc suelta el mouse, P pausa |
...
Con mouse, entrar pide pointer lock para giros ilimitados. Escape suelta el cursor; el siguiente click recaptura. P pausa. Touch y gamepad no requieren captura. LMB rompe y RMB coloca.
